//========================================================================
// top_median_filter.v —— 3×3 中值滤波顶层（MedianFilter 工程，W4 非线性滤波）
// 功能：RGB888 像素流输入 → 3×3 中值滤波 → RGB888 输出（crop 边界）
//       复用 Mean/Gaussian 的架构：1 个行缓存（DW=24）+ 3 个 8bit 核
//
// 数据流：
...
//
// 中值排序网络（19 比较器行排序三部曲）见 median_3x3_8b.v 头部注释
//========================================================================
`timescale 1ns/1ps
...
module top_median_filter #(
    ...
    //========================================================================
    // 3×median_3x3_8b：R/G/B 各一核，共用窗口与 matrix_valid
    //   窗口坐标映射与 Mean/Gaussian 一致：p00=w11（左上）… p22=w33（右下）
    //========================================================================
